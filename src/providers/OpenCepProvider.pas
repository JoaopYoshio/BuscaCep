...
type
  TOpenCEPProvider = class(TInterfacedObject, IEnderecoProvider)
  private
    const BASE_URL = 'https://opencep.com/v1/%s';
  public
...
function TOpenCEPProvider.RetornaNomeProvider: string;
begin
  Result := 'OpenCEP';
end;

function TOpenCEPProvider.BuscarPorCEP(const ACep: string; out AEndereco: TEndereco): Boolean;
var
  Client  : THTTPClient;
